...
class RestDesayuno extends ResourceController
{
    protected $modelName = "App\Models\DesayunoModel";
    ...
    {
        $data = [
            'id_desayuno' => $this->request->getPost('id_desayuno'),
    ...
    {
        $data = [
            'id_desayuno' => $this->request->getVar('id_desayuno'),
