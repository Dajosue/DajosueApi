...
class RestPlatosCarta extends ResourceController
{
    protected $modelName = "App\Models\PlatosCartaModel";
    ...
    {
        $data = [
            'id_platos_carta' => $this->request->getPost('id_platos_carta'),
    ...
    {
        $data = [
            'id_platos_carta' => $this->request->getVar('id_platos_carta'),
