...
class RestMeriendas extends ResourceController
{
    protected $modelName = "App\Models\MeriendasModel";
    ...
    {
        $data = [
            'id_merienda' => $this->request->getPost('id_merienda'),
    ...
    {
        $data = [
            'id_merienda' => $this->request->getVar('id_merienda'),
