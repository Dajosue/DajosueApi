...
class RestTiposBebida extends ResourceController
{
    protected $modelName = "App\Models\TiposBebidaModel";
    ...
    {
        $data = [
            'id_tipo_bebida' => $this->request->getPost('id_tipo_bebida'),
    ...
    {
        $data = [
            'id_tipo_bebida' => $this->request->getVar('id_tipo_bebida'),
